...
||||
|-|-|-|
|<img src="./plots/onap_msb-apigateway.jpg"/> <p style="text-align:left">[Project on Github](https://github.com/onap/msb-apigateway) <br> [Project on SonarCloud ](https://sonarcloud.io/dashboard?id=onap_msb-apigateway) <br> [Complete issue report (JSON)](./json/onap_msb-apigateway.json)</p>|<img src="./plots/onap_msb-discovery.jpg"/> <p style="text-align:left">[Project on Github](https://github.com/onap/msb-discovery) <br> [Project on SonarCloud ](https://sonarcloud.io/dashboard?id=onap_msb-discovery) <br> [Complete issue report (JSON)](./json/onap_msb-discovery.json)</p>|<img src="./plots/onap_msb-java-sdk.jpg"/> <p style="text-align:left">[Project on Github](https://github.com/onap/msb-java-sdk) <br> [Project on SonarCloud ](https://sonarcloud.io/dashboard?id=onap_msb-java-sdk) <br> [Complete issue report (JSON)](./json/onap_msb-java-sdk.json)</p>
 | |

# Project report summaries
## Project: _onap/msb-apigateway_
|./plots/onap_msb-apigateway.jpg|<p style="text-align:left">[Project on Github](https://github.com/onap/msb-apigateway) <br> [Project on SonarCloud ](https://sonarcloud.io/dashboard?id=onap_msb-apigateway) <br> [Complete issue report (JSON)](./json/onap_msb-apigateway.json)</p>
|-|-|
...
|./plots/onap_msb-discovery.jpg|<p style="text-align:left">[Project on Github](https://github.com/onap/msb-discovery) <br> [Project on SonarCloud ](https://sonarcloud.io/dashboard?id=onap_msb-discovery) <br> [Complete issue report (JSON)](./json/onap_msb-discovery.json)</p>
|-|-|
### Top classes with architectural debt violations
| Class name                |   Total issues |   Inheritance |   Exception |   JVMS |   Interface |   Threading |   Complexity | Fully qualified name                                                                                 |
|:--------------------------|---------------:|--------------:|------------:|-------:|------------:|------------:|-------------:|:-----------------------------------------------------------------------------------------------------|
...
|./plots/onap_msb-java-sdk.jpg|<p style="text-align:left">[Project on Github](https://github.com/onap/msb-java-sdk) <br> [Project on SonarCloud ](https://sonarcloud.io/dashboard?id=onap_msb-java-sdk) <br> [Complete issue report (JSON)](./json/onap_msb-java-sdk.json)</p>
|-|-|
### Top classes with architectural debt violations
| Class name                |   Total issues |   Inheritance |   Exception |   JVMS |   Interface |   Threading |   Complexity | Fully qualified name                                                |
|:--------------------------|---------------:|--------------:|------------:|-------:|------------:|------------:|-------------:|:--------------------------------------------------------------------|
